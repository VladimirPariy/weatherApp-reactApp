...
// }
//
// export const ProviderFetchingCurrentWeather  = ( {children}) => {
//     const [currentWeather, setCurrentWeather] = useState(()=> isFetchingCurrentWeather())
//     const [city, setCity] = useState('Kyiv')
//
//     function isFetchingCurrentWeather(city)  {
//         axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=50cb39ad20e8cdadfa2c8ce62827d3fa`).then((response)=>{
...
//
//     return (
//         <ProviderFetchingCurrentWeather.Provider value={{
//             currentWeather:currentWeather
//         }}>
//             {children}
//         </ProviderFetchingCurrentWeather.Provider>
//     )
// }
//
//
